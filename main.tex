...
% Change the badge widths default 2cm
%\setlength{\badgewidth}{2cm}
...
\begin{SummaryImageBox}{Scout-Activity-documents-pp1}
...
\equip{Procedure}
\equip{\href{https://github.com/nimpo/GreyWolfsScoutsActivityTemplate}{This template!}}
\subsection*{Optional}
\equip{Image}
